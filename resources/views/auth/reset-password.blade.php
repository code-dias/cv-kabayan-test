<x-guest-layout>
    ...
    <style>
        ...
        @media (max-width: 576px) {
            ...
            .reset-card { border-radius: 20px; margin: 0 10px; }
        }
    ...
    <div class="auth-wrapper">
        <div class="reset-card">
            <div class="reset-header">
                ...
                <h2 class="fw-bold mb-1 tracking-tight">PEMBARUAN SANDI</h2>
                <p class="small opacity-75 mb-0 text-uppercase tracking-widest">Atur Ulang Kredensial Akun</p>
            </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input id="email" type="email" name="email" class="form-control custom-input" 
                                   value="{{ old('email', $request->email) }}" required autofocus placeholder="nama@kabayan.com">
                        </div>
